...
function getGtitle() {
    ...
    setTimeout(function(){
      $('.noDisplay h1:nth-child(34)').appendTo('.target .header');
      $('.noDisplay.titles').remove();
    }, 3000);
}
function getGmenu() {
    var menu = "";
    routeM = "https://spreadsheets.google.com/tq?key=1kI4-DDcdpPwm3t5e6J-rDuE1l0doyI6nN4us8UCyt2w&gid=1026013340";
    selector = "select *";
